...
publishM2 := {
  ...
  val d = file(sys.env("HOME")) / s".m2/repository/com/wanari/sbt-paradox-swagger_${scalaBinaryVersion.value}_${sbtBinaryVersion.value}"
  d.renameTo(file(sys.env("HOME")) / ".m2/repository/com/wanari/sbt-paradox-swagger")
}
